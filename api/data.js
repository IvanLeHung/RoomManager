    ...
    try {
      if (type === 'full_sync') {
        ...
        const prepareMoveOut = (item) => {
          ...
          ['monthlyRent', 'monthlyFixedServices', 'roomChargeDays', 'proratedRent', 'proratedFixedServices'].forEach(k => { if (data[k] !== undefined) data[k] = toInt(data[k]); });
